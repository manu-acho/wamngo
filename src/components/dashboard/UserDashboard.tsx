...
const mockVotingHistory: VotingHistory[] = [
  {
    id: '1',
    proposalTitle: 'Emergency Medical Fund for Women in Nigeria',
    vote: 'yes',
    votingPower: 2800,
    date: '2025-01-20',
    result: 'passed'
  ...
  {
    id: '2',
    proposalTitle: 'Educational Platform for Young Women',
    vote: 'yes',
    votingPower: 2800,
    date: '2025-01-18',
    result: 'passed'
  ...
  {
    id: '3',
    proposalTitle: 'Legal Aid Network Expansion',
    vote: 'no',
    votingPower: 2650,
    date: '2025-01-15',
    result: 'failed'
  ...
  {
    id: '4',
    proposalTitle: 'Mobile Clinic Initiative',
    vote: 'yes',
    votingPower: 2500,
    date: '2025-01-10',
    result: 'passed'
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="wam-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold wam-text-gradient">
              ${mockUserStats.portfolioValue.toLocaleString()}
            </div>
        ...
        <Card className="wam-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold wam-text-gradient">
              {mockUserStats.walletBalance.toLocaleString()} WAM
            </div>
        ...
        <Card className="wam-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold wam-text-gradient">
              {mockUserStats.votingPower.toLocaleString()}
            </div>
            <p className="text-xs text-gray-600 mt-1">
              {mockUserStats.proposalsVoted} proposals voted
            </p>
          </CardContent>
        </Card>
      </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold">${mockUserStats.portfolioValue.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Wallet Balance</span>
                    <span className="font-semibold">{mockUserStats.walletBalance.toLocaleString()} WAM</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Staked Tokens</span>
                    <span className="font-semibold">{mockUserStats.stakedTokens.toLocaleString()} WAM</span>
                  </div>
                  <div className="flex items-center justify-between">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-semibold text-purple-600">{mockUserStats.totalPoints.toLocaleString()}</span>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-semibold">{mockUserStats.proposalsVoted}</span>
                  </div>
                  <div className="flex justify-between text-sm mb-1">
                    <span>Voting Power</span>
                    <span className="font-semibold">{mockUserStats.votingPower.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between text-sm mb-3">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
                    ...
                    <p className="text-2xl font-bold wam-text-gradient">{mockUserStats.totalPoints}</p>
                ...
                <Button className="w-full wam-button-gradient">
                  <Award className="w-4 h-4 mr-2" />
                  View Available Benefits ({mockUserStats.totalPoints} Points)
                </Button>
